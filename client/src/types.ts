...
export type Project = { id: number; name: string; clientName: string; budgetHours: number; status: "active" | "paused" | "completed" };
export type Timesheet = { id: number; workDate: string; hours: number; description: string; status: "submitted" | "approved" | "rejected"; projectName: string; memberName: string };
